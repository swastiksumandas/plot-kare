...
import { ensureCustomerTypeOnProfile, resumeOnboardingForUser } from '@/lib/onboarding/server'
...
export async function GET(_request: Request, context: RouteContext) {
  ...
  const resume = await resumeOnboardingForUser(auth.supabase, auth.user.id, customerType)
